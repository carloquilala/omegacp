...
<tr class="newTableRow">
    ...
    <td>
        <div class="btn btn-danger delete-row" @click="deleteColumn"><i class="omega-trash"></i></div>
    </td>
...
@include('omega::tools.database.vue-components.database-types')
@include('omega::tools.database.vue-components.database-column-default')
