...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ config('omega.assets_path') }}/css/ga-embed.css">
@stop

@section('content')
    <div class="page-content">
        @include('omega::alerts')
        @include('omega::dimmers')
        <div style="padding:15px;">
            <?php $google_analytics_client_id = Omega::setting("google_analytics_client_id"); ?>
...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
        ...
        <script src="{{ config('omega.assets_path') }}/js/ga-embed/chart.min.js"></script>
        <script src="{{ config('omega.assets_path') }}/js/ga-embed/moment.min.js"></script>
        <!-- Include the ViewSelector2 component script. -->
        <script src="{{ config('omega.assets_path') }}/js/ga-embed/view-selector2.js"></script>
        <!-- Include the DateRangeSelector component script. -->
        <script src="{{ config('omega.assets_path') }}/js/ga-embed/date-range-selector.js"></script>
        <!-- Include the ActiveUsers component script. -->
        <script src="{{ config('omega.assets_path') }}/js/ga-embed/active-users.js"></script>
