...
class TestCase extends OrchestraTestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        // Setup Omega configuration
        $app['config']->set('omega.user.namespace', User::class);
    ...
    protected function install()
    {
        ...
        $this->artisan('omega:install', ['--with-dummy' => $this->withDummy]);

        config()->set(
            'omega',
            require __DIR__.'/../publishable/config/omega.php'
        );
    }
